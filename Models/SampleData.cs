...
namespace LibraryManagement.Models
{
    public static class SampleData
    {
        ...
        {
            new Book { MaSach = "S001", TenSach = "Lập trình C# cơ bản", TacGia = "Nguyễn Văn A", ISBN = "978-604-1-00001-0", TheLoai = "Công nghệ", SoLuong = 5, TrangThai = "Có sẵn" },
            new Book { MaSach = "S002", TenSach = "Cấu trúc dữ liệu và giải thuật", TacGia = "Trần Thị B", ISBN = "978-604-1-00002-7", TheLoai = "Công nghệ", SoLuong = 3, TrangThai = "Có sẵn" },
            new Book { MaSach = "S003", TenSach = "Trí tuệ nhân tạo", TacGia = "Lê Hoàng C", ISBN = "978-604-1-00003-4", TheLoai = "Công nghệ", SoLuong = 2, TrangThai = "Có sẵn" },
            new Book { MaSach = "S004", TenSach = "Văn học Việt Nam hiện đại", TacGia = "Phạm Minh D", ISBN = "978-604-1-00004-1", TheLoai = "Văn học", SoLuong = 4, TrangThai = "Có sẵn" },
            new Book { MaSach = "S005", TenSach = "Lịch sử thế giới cận đại", TacGia = "Võ Thanh E", ISBN = "978-604-1-00005-8", TheLoai = "Lịch sử", SoLuong = 6, TrangThai = "Có sẵn" },
            new Book { MaSach = "S006", TenSach = "Kinh tế vi mô", TacGia = "Hoàng Thị F", ISBN = "978-604-1-00006-5", TheLoai = "Kinh tế", SoLuong = 0, TrangThai = "Hết sách" },
            new Book { MaSach = "S007", TenSach = "Tâm lý học đại cương", TacGia = "Đặng Văn G", ISBN = "978-604-1-00007-2", TheLoai = "Tâm lý", SoLuong = 3, TrangThai = "Có sẵn" },
            new Book { MaSach = "S008", TenSach = "Thiết kế cơ sở dữ liệu", TacGia = "Nguyễn Thị H", ISBN = "978-604-1-00008-9", TheLoai = "Công nghệ", SoLuong = 0, TrangThai = "Hết sách" },
            new Book { MaSach = "S009", TenSach = "Toán cao cấp", TacGia = "Trần Văn I", ISBN = "978-604-1-00009-6", TheLoai = "Toán học", SoLuong = 7, TrangThai = "Có sẵn" },
            new Book { MaSach = "S010", TenSach = "Triết học Mác-Lênin", TacGia = "Lê Thị K", ISBN = "978-604-1-00010-2", TheLoai = "Triết học", SoLuong = 5, TrangThai = "Có sẵn" },
        };
